 ...
 * Возвращает true, если заданное число является степенью двойки, в противном случае — false.
 *
 * @param {number} num
 * @return {boolean}
 *
 ...
 * Возвращает строковое представление числа в указанной базе (основании).
 *
 * @param {number} number
 * @param {number} base
 * @return {string}
 ...
 * Возвращает строковое представление числа в экспоненциальной системе счисления.
 *
 * @param {number} number
 ...
 * Возвращает строковое представление числа в системе счисления с фиксированной запятой
 *
 * @param {number} number
 * @param {number} fractionDigits
 * @return {string}
 ...
 * Возвращает строковое представление числа в обычной системе счисления
 * (с фиксированной точкой или экспоненциальной), округленное до точных значащих цифр.
 *
 * @param {number} number
 ...
 * Возвращает логическое значение, указывающее, является ли число целым или нет.
 *
 * @param {number} number
 * @return {boolean}
 *
 ...
 * Возвращает число с плавающей запятой или, если число не может
 * быть проанализировано из аргумента, возвращает NaN.
 *
 * @param {string} str
 * @return {number | NaN}
 *
 ...
 * Возвращает целое число с указанной базой или, если число
 * невозможно проанализировать из аргумента, возвращает NaN.
 *
 * @param {string} str
 * @param {number} base
 * @return {number | NaN}
 ...
 * Возвращает наибольшее значение, большее или равное заданному значению.
 *
 * @param {number} number
 * @return {number}
 *
 ...
 * Возвращает случайное целое число в диапазоне от минимума до максимума.
 *
 * @param {number} min
 * @param {number} max
 * @return {number}
